...
--
			if isInService and IsJobbutcher() and dist <= 0.5 then
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
			...
			if isInService and IsJobbutcher() and dist <= 25.0 then
...
------------------------- Porcjowanie
			...
			if isInService and IsJobbutcher() and dist2 <= 2.5 then
			DrawText3D(przetworniaX2, przetworniaY2, przetworniaZ2, "~g~[E]~w~ Aby porcjować kurczaka")
			end

			if isInService and IsJobbutcher() and dist2 <= 0.5 then
				if IsControlJustPressed(0, Keys['E']) then -- "E"
				PorcjujKurczaka(2)
				end			
			end

			if isInService and IsJobbutcher() and dist3 <= 2.5 then
				DrawText3D(przetworniaX3, przetworniaY3, przetworniaZ3, "~g~[E]~w~ Aby porcjować kurczaka")
				end
	
				if isInService and IsJobbutcher() and dist3 <= 0.5 then
					if IsControlJustPressed(0, Keys['E']) then -- "E"
					PorcjujKurczaka(3)
					end			
				end
------------------------- Mycie
			if isInService and IsJobbutcher() and distM1 <= 2.5 then
				DrawText3D(mycieX1, mycieY1, mycieZ1, "~g~[E]~w~ Aby umyć kurczaka")
				end
		
				if isInService and IsJobbutcher() and distM1 <= 0.5 then
					if IsControlJustPressed(0, Keys['E']) then -- "E"
					MyjKurczaka(1)
					end			
				end
------------------------- Pakowanie
			if isInService and IsJobbutcher() and distP <= 2.5 and pakuje == 0 then
			DrawText3D(pakowanieX, pakowanieY, pakowanieZ, "~g~[E]~w~ Aby pakować kurczaka")
			elseif isInService and IsJobbutcher() and distP <= 2.5 and pakuje == 1 then
			...
			if isInService and IsJobbutcher() and distP <= 0.5 then
			...
			if isInService and IsJobbutcher() and distP2 <= 2.5 and pakuje == 0 then
			DrawText3D(pakowanieX2, pakowanieY2, pakowanieZ2, "~g~[E]~w~ Aby pakować kurczaka")
			elseif isInService and IsJobbutcher() and distP2 <= 2.5 and pakuje == 1 then
			...
			if isInService and IsJobbutcher() and distP2 <= 0.5 then
				if IsControlJustPressed(0, Keys['E']) then -- "E"
				PakujKurczaka(2)
				elseif IsControlJustPressed(0, Keys['G']) then
				PrzestanPakowac(2)
			...
			if isInService and IsJobbutcher() and distP3 <= 2.5 and pakuje == 0 then
				DrawText3D(pakowanieX3, pakowanieY3, pakowanieZ3, "~g~[E]~w~ Aby pakować kurczaka")
				elseif isInService and IsJobbutcher() and distP3 <= 2.5 and pakuje == 1 then
			...
			if isInService and IsJobbutcher() and distP3 <= 0.5 then
				if IsControlJustPressed(0, Keys['E']) then -- "E"
				PakujKurczaka(3)
				elseif IsControlJustPressed(0, Keys['G']) then
				PrzestanPakowac(3)
			...
			if isInService and IsJobbutcher() and distP4 <= 2.5 and pakuje == 0 then
				DrawText3D(pakowanieX4, pakowanieY4, pakowanieZ4, "~g~[E]~w~ Aby pakować kurczaka")
				elseif isInService and IsJobbutcher() and distP4 <= 2.5 and pakuje == 1 then
			...
			if isInService and IsJobbutcher() and distP4 <= 0.5 then
				if IsControlJustPressed(0, Keys['E']) then -- "E"
				PakujKurczaka(4)
				elseif IsControlJustPressed(0, Keys['G']) then
				PrzestanPakowac(4)
			...
			if isInService and IsJobbutcher() and distP5 <= 2.5 and pakuje == 0 then
				DrawText3D(pakowanieX5, pakowanieY5, pakowanieZ5, "~g~[E]~w~ Aby pakować kurczaka")
				elseif isInService and IsJobbutcher() and distP5 <= 2.5 and pakuje == 1 then
			...
			if isInService and IsJobbutcher() and distP5 <= 0.5 then
				if IsControlJustPressed(0, Keys['E']) then -- "E"
				PakujKurczaka(5)
				elseif IsControlJustPressed(0, Keys['G']) then
				PrzestanPakowac(5)
...
---------Porcjowanie
local dismember = false
RegisterNetEvent("srp:butcher:candismember2")
AddEventHandler("srp:butcher:candismember2", function(count)
	if count == 1 then
		dismember = true
	elseif count == 0 then
		dismember = false
...
Citizen.CreateThread(function()
	...
	if isInService and IsJobbutcher() and dist <= 2.0 then
