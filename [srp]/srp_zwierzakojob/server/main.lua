...
RegisterServerEvent('srp_zwierzakojob:startHarvest')
AddEventHandler('srp_zwierzakojob:startHarvest', function()
...
RegisterServerEvent('srp_zwierzakojob:stopHarvest')
AddEventHandler('srp_zwierzakojob:stopHarvest', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:startHarvest2')
AddEventHandler('srp_zwierzakojob:startHarvest2', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:stopHarvest2')
AddEventHandler('srp_zwierzakojob:stopHarvest2', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:startHarvest3')
AddEventHandler('srp_zwierzakojob:startHarvest3', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:stopHarvest3')
AddEventHandler('srp_zwierzakojob:stopHarvest3', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:startCraft')
AddEventHandler('srp_zwierzakojob:startCraft', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:stopCraft')
AddEventHandler('srp_zwierzakojob:stopCraft', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:startCraft2')
AddEventHandler('srp_zwierzakojob:startCraft2', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:stopCraft2')
AddEventHandler('srp_zwierzakojob:stopCraft2', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:startCraft3')
AddEventHandler('srp_zwierzakojob:startCraft3', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:stopCraft3')
AddEventHandler('srp_zwierzakojob:stopCraft3', function()
	local _source = source
	PlayersCrafting3[_source] = false
end)

RegisterServerEvent('srp_zwierzakojob:onNPCJobMissionCompleted')
AddEventHandler('srp_zwierzakojob:onNPCJobMissionCompleted', function()
	local _source = source
...
RegisterServerEvent('srp_zwierzakojob:buyrepairkit')
AddEventHandler('srp_zwierzakojob:buyrepairkit', function(source)
	local _source = source
	local xPlayer  = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('srp_zwierzakojob:setVehicleHoodState')
AddEventHandler('srp_zwierzakojob:setVehicleHoodState', function(vehicle, state)
	TriggerClientEvent("srp_zwierzakojob:setVehicleHoodStates", -1, vehicle, state)
end)

RegisterServerEvent('srp_zwierzakojob:getStockItem')
AddEventHandler('srp_zwierzakojob:getStockItem', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('srp_zwierzakojob:getStockItems', function(source, cb)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_zwierzako', function(inventory)
		cb(inventory.items)
	end)
end)

RegisterServerEvent('srp_zwierzakojob:putStockItems')
AddEventHandler('srp_zwierzakojob:putStockItems', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('srp_zwierzakojob:getPlayerInventory', function(source, cb)
	local xPlayer    = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('srp_zwierzakojob:get_item')
AddEventHandler('srp_zwierzakojob:get_item', function(itemLabel, itemName, itemCount)
...
RegisterServerEvent("srp_zwierzakojob:giveWeapon")
AddEventHandler("srp_zwierzakojob:giveWeapon", function(weapon)
...
RegisterServerEvent('srp_zwierzakojob:putStockItems2')
AddEventHandler('srp_zwierzakojob:putStockItems2', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
	local sourceItem = xPlayer.getInventoryItem(itemName)
