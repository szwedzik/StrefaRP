...
Config.Zones = {
	ZwierzakoActions = {
	  Pos   = { x = 549.90, y = -172.25, z = 53.50},
	  Size  = { x = 1.5, y = 1.5, z = 1.0 },
	  Color = { r = 204, g = 204, b = 0 },
	  Type  = 27,
	},

	ZwierzakoActionsShop = {
		Pos   = { x = 28.19, y = -1769.5, z = 28.60},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
	...
	Garage = {
	  Pos   = { x = -183.34, y = -1319.42, z = -201.3 },
	  Size  = { x = 1.5, y = 1.5, z = 1.0 },
	  Color = { r = 204, g = 204, b = 0 },
	  Type  = -1,
	},
	...
	Craft = {
	  Pos   = { x = -198.38, y = -1315.2, z = -200.08 },
	  Size  = { x = 1.5, y = 1.5, z = 1.0 },
	  Color = { r = 204, g = 204, b = 0 },
	  Type  = -1,
	},
	...
	VehicleSpawnPoint = {
	  Pos   = { x = 505.17, y = -99.83, z = 62.82 },
	  Size  = { x = 1.5, y = 1.5, z = 1.0 },
	  Type  = -1,
	},
  
	VehicleDeleter = {
	  Pos   = { x = 502.03, y = -105.93, z = 62.34 },
	...
	VehicleDelivery = {
	  Pos   = { x = -382.925, y = -133.748, z = -1007.685 },
