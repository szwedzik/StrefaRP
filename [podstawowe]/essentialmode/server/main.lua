...
AddEventHandler('playerConnecting', function(name, setKickReason)
	...
	if not id then
		setKickReason("[SRP] Nie wykryto działania Steam. Uruchom go i zrestartuj FiveM.")
		CancelEvent()
	end
end)
...
AddEventHandler('es:firstJoinProper', function()
	...
	Citizen.CreateThread(function()
		...
		if not id then
			DropPlayer(Source, "[SRP] Nie wykryto działania Steam. Uruchom go i zrestartuj FiveM.")
		else
