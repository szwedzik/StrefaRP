...
$(document).ready(function(){
  ...
  window.addEventListener('message', function(event){
    ...
    if(item.clearme == true) {
      ...
      if(!$("#btnCar13").hasClass('btnCar')) { $("#btnCar13").addClass('btnCar'); }
      if(!$("#btnCar14").hasClass('btnCar')) { $("#btnCar14").addClass('btnCar'); }
      if(!$("#btnCar15").hasClass('btnCar')) { $("#btnCar15").addClass('btnCar'); }
      if(!$("#btnCar16").hasClass('btnCar')) { $("#btnCar16").addClass('btnCar'); }
      if(!$("#btnCar17").hasClass('btnCar')) { $("#btnCar17").addClass('btnCar'); }
    }
  ...
  // Handle Button Presses
  $("#btnCar13"). click(function(){
    var model = $(this).attr('model');
    $.post('http://netr_garages/pullCar',  JSON.stringify({ model: $(this).attr('model') }));
  });

  // Handle Button Presses
  $("#btnCar14"). click(function(){
    var model = $(this).attr('model');
    $.post('http://netr_garages/pullCar',  JSON.stringify({ model: $(this).attr('model') }));
  });

  // Handle Button Presses
  $("#btnCar15"). click(function(){
    var model = $(this).attr('model');
    $.post('http://netr_garages/pullCar',  JSON.stringify({ model: $(this).attr('model') }));
  });

  // Handle Button Presses
  $("#btnCar16"). click(function(){
    var model = $(this).attr('model');
    $.post('http://netr_garages/pullCar',  JSON.stringify({ model: $(this).attr('model') }));
  });

  // Handle Button Presses
  $("#btnCar17"). click(function(){
    var model = $(this).attr('model');
    $.post('http://netr_garages/pullCar',  JSON.stringify({ model: $(this).attr('model') }));
  });
