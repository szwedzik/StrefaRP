cfg = {
	...
	damageFactorPetrolTank = 28.0,				-- Sane values are 1 to 100. Higher values means more damage to vehicle. A good starting point is 64
...
repairCfg = {
	mechanics = {
		{name="Mechanic", id=446, r=25.0, x=-337.0,  y=-135.0,  z=-1000.0},	-- LSC Burton
	},
