...
Config.ArmoryWeapons = {
	--{ ["label"] = " ------- Broń Długa -------"},
	{ ["hash"] = "weapon_carbinerifle", ["type"] = "rifle" , components = { nil, nil, nil, 0, 0, nil , 0 ,nil} },
	{ ["hash"] = "weapon_pumpshotgun", ["type"] = "rifle" , components = { 0, nil, nil} },
	{ ["hash"] = "weapon_pistol", ["type"] = "pistol", components = { nil, 0, 0, nil, 0} },
	{ ["hash"] = "weapon_combatpistol", ["type"] = "pistol", components = { nil, nil, 0, nil, nil} },
	{ ["hash"] = "weapon_heavypistol", ["type"] = "pistol", components = { nil, 0, 0, nil, 0}},
