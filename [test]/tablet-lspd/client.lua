...
Citizen.CreateThread(function()
  ...
  while true do
    Citizen.Wait(10)
        ...
        SendNUIMessage({event = 'ShowPoliceTablet', isVisible = open })
		  end
  end
end)
...
--   ESX.TriggerServerCallback('tablet:save', function( d )
--     cb(d)
--   end, data)
-- end)
...
--   ESX.TriggerServerCallback('tablet:fetch', function( d )
--     cb(d)
--   end, data)
-- end)
...
--   ESX.TriggerServerCallback('tablet:remove', function( d )
--     cb(d)
--   end, data)
-- end)
