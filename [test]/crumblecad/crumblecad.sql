...
INSERT INTO `cad_convictions` (`officer`, `steamIdentifier`, `suspect_name`, `reason`, `time_served`, `date`) VALUES
('Tommy Cornell', 'Char3:1100001078fc88d', 'Lane Frost', 'Was involved in a bank robbery..... Was involved in a bank robbery..... Was involved in a bank robbery..... Was involved in a bank robbery..... Was involved in a bank robbery.....', 112, '11/08/2019');
...
INSERT INTO `cad_fines` (`steamIdentifier`, `officer`, `receiver`, `reason`, `amount`, `date`, `paid`) VALUES
('Char3:1100001078fc88d', 'Joey Tsunami', 'Lane Frost', 'testing new shit.', 123, '15/08/2019', 'n');
...
INSERT INTO `cad_reports` (`officer`, `steamIdentifier`, `suspects_name`, `report`, `date`) VALUES
('Susan Doyle', NULL, NULL, 'Was walking down legion on patrol and see an individual pass over what appeared to be a white substance. Persude on foot, however the suspect managed to escape. He was wearing all green, possibly as member of grove? ', '08/08/19'),
('Susan Doyle', 'Char3:1100001078fc88d', 'Lane Frost', 'Pertaining to the report I made previously, I managed to catch up with the suspect and detain him. The suspect in question, turned out to be one Mr Lane Frost, a head lieutenant of Grove Street. Upon searching Mr Frost, I found numerous backs of what appe', '08/08/19');
...
INSERT INTO `cad_warrants` (`steamIdentifier`, `officer`, `receiver`, `reason`, `date_issued`, `warrant_active`) VALUES
('Char3:1100001078fc88d', 'Joey Tsunami', 'Lane Frost', 'testing warrant shit', '01/01/1111', 'y');
