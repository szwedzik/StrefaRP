...
AddEventHandler('kashactersC:SetupCharacters', function()
    ...
    cam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", 741.55, 1268.56, 400.01, 310.00,0.00,150.00, 100.00, false, 0)
...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
    ...
    DoScreenFadeIn(500)
    Citizen.Wait(500)
    cam2 = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", 741.55, 1268.56, 400.01, 310.00,0.00,150.00, 100.00, false, 0)
