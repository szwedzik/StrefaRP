local Keys = {
  ...
  function OpenCloakroomMenu()
	  ...
	  local elements = {
		  ...
		  { label = 'Kamizelka kuloodporna LSPD', value = 'bullet_wear4' },
		  {label = 'Bojowy', value = 'lspd4_wear'},
	  }
	  table.insert(elements, {label = '--------------------LSPD--------------------', value = 'xD'})
	  table.insert(elements, {label = 'Motor', value = 'moto_wear'})
	  table.insert(elements, {label = 'Kurtka', value = 'kurtka_wear'})
	  table.insert(elements, {label = 'Mundur - długi rękaw', value = 'lspd_wear'})
	  table.insert(elements, {label = 'Mundur - krótki rękaw', value = 'lspd5_wear'})
	  table.insert(elements, {label = 'Mundur kadeta', value = 'lspdkadet_wear'})
	  table.insert(elements, {label = 'Niebieska kurtka', value = 'lspd2_wear'})
	  table.insert(elements, {label = 'Deszczówka', value = 'lspd3_wear'})
	  table.insert(elements, {label = 'Swobodne', value = 'lspd6_wear'})
	  table.insert(elements, {label = 'Rowerowy', value = 'lspd7_wear'})
  ...
  function OpenVehicleSpawnerMenu(type, station, part, partNum)
	  ...
	  if type == 'car' then
		  ...
		  table.insert(elements, { label = 'Autobus więzienny', value = 'pbus'})
		  table.insert(elements, { label = 'Crown Victoria', value = 'victorialspd'}) -- Działa (inne liversy)
		  table.insert(elements, { label = 'Ford Explorer', value = 'explorerlspd'}) -- Działa
		  table.insert(elements, { label = 'Dodge Charger 15', value = 'chargerlspd'})
		  ...
		  table.insert(elements, { label = 'Dodge Charger 18', value = '18chargerlspd'})
	  elseif type == 'helicopter' then
		  table.insert(elements, { label = 'Maverick', value = 'vcpdmav11'})
