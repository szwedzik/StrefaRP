...
function OpenAccessoryMenu()
	...
	'default', GetCurrentResourceName(), 'set_unset_accessory',
	{
		...
		align = 'bottom-right',
		elements = {
			{label = 'Kask/Czapka', value = 'helmet', value2 = 'helmet', lib = 'missheistdockssetup1hardhat@', anim  = 'put_on_hat' },
			{label = 'Szyja',		value = 'chain_1', value2 = 'chain_2', lib = 'mp_masks@standard_car@rds@', anim  = 'put_on_mask' },
			{label = 'Uszy', 		value = 'ears', value2 = 'ears', lib = 'mp_masks@standard_car@rds@', anim  = 'put_on_mask' },
			{label = 'Maska', 		value = 'mask', value2 = 'mask', lib = 'mp_masks@standard_car@rds@', anim  = 'put_on_mask' },
			{label = 'Okulary', 	value = 'glasses', value2 = 'glasses', lib = 'mp_masks@standard_car@rds@', anim  = 'put_on_mask' },
	...
	for k,v in pairs(Config.ShopsBlips) do
		if v.Pos ~= nil then
			for i=1, #v.Pos, 1 do
				...
				AddTextComponentString('Sklep z maskami')
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlPressed(0, Keys['-']) and IsControlPressed(0, Keys['LEFTSHIFT']) --[[and GetLastInputMethod(2) and not isDead]] then
			OpenAccessoryMenu()
		end
	end
end)