...
RegisterNetEvent('esx_anims:lockpick')
AddEventHandler('esx_anims:lockpick', function(state)
	Lockpicking = state
end)

RegisterNetEvent('esx_anims:scoreboard')
AddEventHandler('esx_anims:scoreboard', function(state)
	Scoreboard = state
end)

RegisterNetEvent('esx_anims:repair')
AddEventHandler('esx_anims:repair', function(state)
	Repairing = state
end)
...
Citizen.CreateThread(function()
  while true do
  Citizen.Wait(10)
	  if not Repairing and not Lockpicking and not Scoreboard then
