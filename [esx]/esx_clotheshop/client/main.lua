...
function OpenShopMenu()
	...
	TriggerEvent('esx_skin:openRestrictedMenu', function(data, menu)
					...
					if hasEnoughMoney then
						...
						ESX.TriggerServerCallback('esx_property:getPlayerDressing', function(dressing)
							...
							if (max < 20) then 
										...
										ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'save_dressing',
										{
											...
											if data2.current.value == 'yes' then
												...
												'dialog', GetCurrentResourceName(), 'outfit_name',
												{
													...
													menu3.close()
													TriggerEvent('skinchanger:getSkin', function(skin)
														if string.len(data3.value) > 3 and string.len(data3.value) < 30 then
															TriggerServerEvent('esx_clotheshop:saveOutfit', data3.value, skin)
														else
															exports['mythic_notify']:DoCustomHudText('inform', "Nazwa ubioru nie może być krótsza od 3 a dłuższa od 30 znaków!", 10000)
														end
													end)
								...
								ESX.ShowNotification('~r~Twoja szafa nie zmieści więcej ubrań.\n~s~Wróć do domu i wyrzuć trochę')		
							end
						end)
					else
		...
		CurrentActionMsg  = _U('press_menu')
		CurrentActionData = {}
	end, {'tshirt_1','tshirt_2','torso_1','torso_2','decals_1','decals_2','arms','pants_1','pants_2','shoes_1','shoes_2','chain_1','chain_2','bags_1','bags_2',})
end
